...
module.exports = { sendOtpEmail, sendEventReminderEmail, sendRefundUpdateEmail, sendPromotionalEmail, sendTestEmail, sendEventApprovalEmail, isEmailConfigured, verifyEmailService, sendMail };
